...
@section('page-header')
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">{{ __('Frontend/frontend.companies') }}</h4>
                    <span class="text-muted mt-1 tx-13 mr-2 mb-0">&nbsp; /  {{ __('Frontend/frontend.compaines_list') }}</span>
                </div>
            </div>
        </div>
        <!-- breadcrumb -->
...
@section('content')
            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                        <!-- اضافة فاتورة -->
                        <a href="companies/create" class="modal-effect btn btn-primary" style="color:white">
                            <i class="fas fa-plus"></i>&nbsp; {{ __('Frontend/frontend.add_company') }}
                        </a>
                            ...
                            <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">{{ __('Frontend/frontend.website_url') }}</th>
                                        <th class="border-bottom-0">{{ __('Frontend/frontend.logo') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ( $companies as $company )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('storage'.'/'.$company->pic) }}" alt="img">
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        <!-- +++++++++++++++++++++++++++++++ حذف الشركة +++++++++++++++++++++++++++++++ -->
        <div  class="modal fade" id="delete_company" tabindex="-1" role="dialog"
