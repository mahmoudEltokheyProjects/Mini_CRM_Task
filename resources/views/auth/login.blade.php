...
@section('title')
    {{ __('Frontend/frontend.login_tab_title') }}
@stop
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex">
                                        ...
                                        <h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Eltokhey<span>So</span>ft</h1></div>
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2> {{ __('Frontend/frontend.login_welcome_msg') }}</h2>
                                            <h5 class="font-weight-semibold mb-4">
                                                {{ __('Frontend/frontend.login_header_title') }}
                                            </h5>
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img src="{{URL::asset('assets/img/media/work-steps.png')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
                    </div>
                </div>
            </div>
